...
namespace X39.Software.ExamMaker.Api.Storage.Migrations
{
    ...
    [Migration("20260107100055_AddStringPdfTemplateToExam")]
    partial class AddStringPdfTemplateToExam
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("X39.Software.ExamMaker.Api.Storage.Exam.Entities.Exam", b =>
                {
                    ...
                    b.Property<string>("PdfTemplate")
                        .IsRequired()
                        .HasMaxLength(1048575)
                        .HasColumnType("character varying(1048575)");
