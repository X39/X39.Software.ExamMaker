...
public static class ClaimsPrincipalExtensions
{
    ...
    extension(ClaimsPrincipal principal)
    {
        ...
        /// </returns>
        public bool ResolveOrganizationId(out long organizationId)
        {
        ...
        /// </returns>
        public bool ResolveUserId(out long userId)
        {
        ...
        public bool ResolveEMail([NotNullWhen(true)] out string? email)
        {
        ...
        public string? ResolveEMail() => principal.ResolveEMail(out var email) ? email : null;
        ...
        public bool ResolveOrganizationName(
        ...
        public string? ResolveOrganizationName()
            => principal.ResolveOrganizationName(out var organizationName) ? organizationName : null;
        ...
        public string? ResolveName()
            => principal.ResolveName(out var organizationName) ? organizationName : null;
    }
}
